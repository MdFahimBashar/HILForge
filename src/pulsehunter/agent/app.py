...
from pulsehunter.agent.config import AgentSettings
from pulsehunter.agent.runtime import AgentControlLoop, AgentEngine, TransientSimulationError
...
app = FastAPI(
    title=f"PulseHunter simulated device: {settings.name}",
    version="0.1.0",
    lifespan=lifespan,
)
